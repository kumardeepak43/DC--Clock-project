...
function alarmTimings() {
    ...
    if (time == wakeUpTime) {
        document.getElementById("leftImagePart").src = "Component 30 – 1.svg";
    } else if (time == lunchTime) {
        document.getElementById("leftImagePart").src = "Component 31 – 1.svg";
    } else if (time == napTime) {
        document.getElementById("leftImagePart").src = "lunch_image.png";
    } else if (time == nightTime) {
        document.getElementById("leftImagePart").src = "Component 32 – 1.svg";
    } else {
        document.getElementById("leftImagePart").src = "Component 30 – 1.svg";
    }
